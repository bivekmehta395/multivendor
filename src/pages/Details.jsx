                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='text-2xl text-red-500 font-bold flex gap-3'>
                                {
                                    product.discount !== 0 ? <>
                                        <h2 className='line-through'>Npr{product.price}</h2>
                                        <h2>Npr{product.price - Math.floor((product.price * product.discount) / 100)} (-{product.discount}%)</h2>
                                    </> : <h2>Price : Npr{product.price}</h2>
                                }
                            </div>
                                            ...
                                            return (
                                                <Link className='block'>
                                                    ...
                                                    <div className='flex gap-2'>
                                                        <h2 className='text-[#6699ff] text-lg font-bold'>Npr{p.price}</h2>
